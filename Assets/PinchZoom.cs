...
public class PinchZoom : MonoBehaviour
{
    ...
    void start()
    {
        ...
        originalPos = GetComponent<Camera>().transform.position;
    }
    ...
    void Update()
    {
        ...
        if (Input.touchCount == 1 && Input.GetTouch(0).phase == TouchPhase.Began && Input.GetTouch(0).tapCount == 2)
        {
            ...
            GetComponent<Camera>().transform.position = originalPos;
        }
        ...
        if (Input.touchCount == 2)
        {
            ...
            if (initialSceenMidPoint.x - (midpoint.x * cameraScale) < Screen.width / 2 && initialSceenMidPoint.y - (midpoint.y * cameraScale) < Screen.height / 2)
